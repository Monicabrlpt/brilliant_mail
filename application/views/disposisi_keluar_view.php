            ...
            <div class="content_bottom">
                ...
                <div class="bs-example1" data-example-id="contextual-table"><span><h3>Tabel Disposisi Keluar</h3></span></div>
       </div>
  ...
  <div class="bs-example4" data-example-id="simple-responsive-table">
    <div class="table-responsive">
      ...
      <table class="table" id="tabel-surar-masuk">
         <a href="#" class="btn btn-primary btn-sm" target="_blank" data-toggle="modal" data-target="#modal_add">Tambah Disposisi</a> <br><br><span class="label btn_6 label-default">No. Surat : <?php echo $data_surat->nomor_surat; ?> </span> <br> <br>
        <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>TUJUAN UNIT</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($data_disposisi as $disposisi) {
                                        ...
                                        if($disposisi->id_user_pengirim == $this->session->userdata('id_user')){
                                        ...
                                        echo '
                                                <td>
                                                    ...
                                                    <a href="'.base_url('index.php/surat/hapus_disposisi_keluar/'.$this->uri->segment(3).'/'.$disposisi->id_disposisi).'" class="btn btn-danger btn-sm">Hapus</a>
                                                </td>
                                            </tr>
                                        ';
                                    }
  ...
  <div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-labelledby="modal_addLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo base_url('index.php/surat/tambah_disposisi_keluar/'.$this->uri->segment(3)) ?>" method="post">
